...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/Topologiya.png)  
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/CLI(1).png)  
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/CLI(2).png)  
 
```
ip -c a
```
 
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/CLI(3).png)  
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/ISP(1).png)   
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/ISP(2).png)  
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/ISP(3).png)  
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/ISP(4).png)  
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/ISP(5).png)   
...
nmtui
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(1).png)
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(2).png)
...
enter
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(3).png)  
```
systemctl restart network
ip -c a
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(4).png)
...
nmtui
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(1).png)  
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(2).png)  
...
enter
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(3).png)  
```
systemctl restart network
ip -c a
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(4).png)  

## **BR-SRV**  
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-SRV(1).png)

```
ip -c a
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-SRV(2).png)
...
nmtui
``` 
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(5).png)  
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(6).png) 

## **BR-R**
```
nmtui
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(5).png)  
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(6).png)
...
ospfd=yes
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(7).png)  
...
ospfd=yes
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(7).png)  
...
exit
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/Screenshot_1.png)
...
enter
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(9).png)  
```
cp /etc/dhcp/dhcpd.conf{.example,}
nano /etc/dhcp/dhcpd.conf
```
поправляем файл:  
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(10).png)  
...
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(11).png)   
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-SRV(5).png)  
...
## **CLI**
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/CLI(5).png)
...
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(9).png)  
...
passwd network-admin
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-SRV(5).png)  
...
passwd admin
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(12).png)
...
passwd admin
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-SRV(4).png)  
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(13).png)
...
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(14).png)  
```
ctrl-x
y
жмём enter
...
nano backup-script.sh
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/BR-R(10).png)  
```
ctrl-x
y
жмём enter
...
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-SRV(6).png)  
...
nft list ruleset
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-R(15).png)  
...
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-SRV(7).png)  
...
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-SRV(8).png)  

```
systemctl restart nftables
nft list ruleset
```
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/HQ-SRV(9).png)  

Выполняем проверку:  
## **CLI**
![image](https://github.com/Sedreg1/Demo-exzamen/blob/main/screenshot/CLI(6).png)  
